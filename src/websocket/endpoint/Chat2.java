...
public class Chat2 {
    ...
    private static final Logger log = Logger.getLogger(Chat2.class.getName());

    private static final String GUEST_PREFIX = "Guest";
    private static final AtomicInteger connectionIds = new AtomicInteger(0);
    private static final Set<Chat2> connections =
    ...
    public void incoming(String json) {
        ...
        String filteredMessage = String.format("%s: %s",
                incomingMessage.getUsername(), filter(incomingMessage.getMessage()));
